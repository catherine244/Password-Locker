...
class TestCredentials(unittest.TestCase):
    ...
    def test_save_multiple_credentials(self):
            ...
            test_credentials = Credentials("Test","user","abcd45678","test@user.com") # new account
            ...
            '''
            self.new_credentials.save_credentials()
            test_credentials = Credentials("Test","user","abcd45678","test@user.com") # account
            test_credentials.save_credentials()
    ...
    def test_credentials_exists(self):
        ...
        credentials_exists = Credentials.credentials_exist("abcd45678")
